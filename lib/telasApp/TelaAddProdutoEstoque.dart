...
class TelaAddProdutoEstoqueWidget extends StatefulWidget {
  @override
  _TelaAddProdutoEstoqueState createState() =>
      _TelaAddProdutoEstoqueState();
}

class _TelaAddProdutoEstoqueState
    extends State<TelaAddProdutoEstoqueWidget> {
